  ...
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    ...
    <main class="px-4 py-6">
      ...
      <div class="mt-6">
        <div>
          <div>
            <img class="rounded-lg shadow-md h-64 mx-auto" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="">
          </div>        
          <div class="relative px-4 -mt-16">
            <div class="bg-white rounded-lg px-4 py-4 shadow-lg">
              ...
              <div class="mt-1">
                <span class="text-gray-900">$1,400
