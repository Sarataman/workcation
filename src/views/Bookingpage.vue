<template>
    <div id="bookingpage" class="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:h-screen">
        ...
        <main class="py-6 xl:flex-1 xl:overflow-x-hidden">
            ...
            <div class="px-4 sm:flex sm:-ml-2 sm:pb-8">
                <div v-for="(property, i) in properties" :class="{'mt-10 sm:ml-4': i > 0}" class="sm:mt-0 sm:max-w-xs sm:w-full sm:flex-shrink-0 sm:px-2">
