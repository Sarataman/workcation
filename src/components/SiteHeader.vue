<template>
    <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
      ...
      <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden': !isOpen, 'block': isOpen }">
          <div class="hidden xl:block xl:relative xl:max-w-xs l:w-full">
            ...
            <input class="block w-full bg-gray-200 border border-transparent focus:outline-none focus:bg-white focus:text-gray-300 focus:border-gray-300 text-gray-900 rounded-lg px-10 pr-4 py-2" placeholder="Search by keywords">
          </div>
          <div class="sm:flex sm:items-center">
            <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:text-sm sm:px-0">
                <a href="#" class="block px-3 py-1 rounded font-semibold text-white hover:bg-gray-800 sm:px-2 xl:text-gray-900 xl:hover:bg-gray-200">List your property</a>
                <a href="#" class="mt-1 sm:mt-0 px-3 py-1 rounded block font-semibold text-white hover:bg-gray-800 sm:px-2 sm:ml-2 xl:text-gray-900 xl:hover:bg-gray-200">Trips</a>
                <a href="#" class="mt-1 sm:mt-0 px-3 py-1 rounded block font-semibold text-white hover:bg-gray-800 sm:px-2 sm:ml-2 xl:text-gray-900 xl:hover:bg-gray-200">Messages</a>
                </div>
                ...
                <Dropdown class="hidden sm:block">
                    ...
                    <template #dropdown>
                        <div class="mt-3 bg-white xl:border rounded-lg w-48 py-2 shadow-xl">
                            <a href="#account" class="block text-gray-400 hover:text-white text-gray-800 px-4 py-2 hover:bg-indigo-500">Account Settings</a>
                            <a href="#support" class="block text-gray-400 hover:text-white text-gray-800 px-4 py-2 mt-0 hover:bg-indigo-500">Support</a>
                            <a href="#sign-out" class="block text-gray-400 hover:text-white text-gray-800 px-4 py-2 mt-0 hover:bg-indigo-500">Sign out</a>
                        </div>
                    </template>
                </Dropdown>
            </div>
