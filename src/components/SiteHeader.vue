    ...
    <header class="bg-gray-900">
      ...
      <nav v-show="isOpen">
        <div class="px-2 pt-2 pb-5 border-b border-gray-800">
          ...
          <a href="#" class="mt-1 px-3 py-1 rounded block font-semibold text-white hover:bg-gray-800">Trips</a>
          <a href="#" class="mt-1 px-3 py-1 rounded block font-semibold text-white hover:bg-gray-800">Messages</a>
        </div>
        <div class="px-5 py-5">
