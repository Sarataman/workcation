<template>
    <section class="bg-gray-800 px-4 py-3">
        <div class="flex justify-between pb-2">
            <div class="relative">
                ...
                <input class="bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg px-10 pr-4 py-2" placeholder="Search by keywords">
            </div>
            <button type="button" class="inline-flex items-center bg-gray-600 hover:bg-gray-600 rounded-lg focus:outline-none focus:shadow-outline pl-3 pr-4"
                @click="toggle" 
        ...
        <form v-show="isOpen">
            <div class="px-4 py-4 border-t border-gray-900">
                <div class="flex -mx-2">
                    <label class="block w-1/2 px-2">
                        ...
                        <select class="mt-1 form-select block w-full text-white shadow focus:bg-gray-600" name="" id="">
            ...
            <div class="px-4 py-4 border-t border-gray-900">
                ...
                <label class="mt-3 flex items-center" for="">
                    <input class="form-radio bg-gray-900 focus:bg-gray-700" type="radio" name="propertyType" value="house" id="">
                    <span class="ml-2 text-white">House</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-radio bg-gray-900 focus:bg-gray-700" type="radio" name="propertyType" value="apartment" id="">
                    <span class="ml-2 text-white">Apartment</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-radio bg-gray-900 focus:bg-gray-700" type="radio" name="propertyType" value="loft" id="">
                    <span class="ml-2 text-white">Loft</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-radio bg-gray-900 focus:bg-gray-700" type="radio" name="propertyType" value="townhouse" id="">
            ...
            <div class="px-4 py-4 border-t border-gray-900">
                ...
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="balcony" id="">
                    <span class="ml-2 text-white">Balcony</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="airConditioning" id="">
                    <span class="ml-2 text-white">Airconditioning</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="pool" id="">
                    <span class="ml-2 text-white">Pool</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="beach" id="">
                    <span class="ml-2 text-white">Beach</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="petFriendly" id="">
                    <span class="ml-2 text-white">Pet friendly</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="kidFriendly" id="">
                    <span class="ml-2 text-white">Kid friendly</span>
                </label>
                <label class="mt-3 flex items-center" for="">
                    <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="parking" id="">
